...
const yes1 = document.getElementById('female');
const no1 = document.getElementById('male');
const helloInput = document.getElementById('helloInput');
const helloInput01 = document.getElementById('helloInput01');
const byInput = document.getElementById('byInput');
const yes2 = document.getElementById('married');
const no2 = document.getElementById('single');
const hello2Input = document.getElementById('hello2Input');
const by2Input = document.getElementById('by2Input');
...
yes1.addEventListener('change', function() {
    if (yes1.checked) {
        ...
        helloInput01.style.display = 'block';
        byInput.style.display = 'none';
    }
});
...
no1.addEventListener('change', function() {
    if (no1.checked) {
        ...
        helloInput01.style.display = 'none';
        byInput.style.display = 'block';
    }
});

yes2.addEventListener('change', function() {
    if (yes2.checked) {
        hello2Input.style.display = 'block';
        by2Input.style.display = 'none';
    }
});

no2.addEventListener('change', function() {
    if (no2.checked) {
        hello2Input.style.display = 'none';
        by2Input.style.display = 'block';
    }
});
